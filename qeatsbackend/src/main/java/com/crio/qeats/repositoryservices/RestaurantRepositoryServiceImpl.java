...
public class RestaurantRepositoryServiceImpl implements RestaurantRepositoryService {
  ...
  public List<Restaurant> findRestaurantsByAttributes(
    ...
    List<Pattern> searchPatterns = Arrays.stream(searchString.split(" "))
    ...
    //restaurants are stored based on query condition
  ...
  //returning restaurants based on item
  private List<Restaurant> getRestaurantListServingItems(Double latitude, 
      Double longitude,LocalTime currentTime, Double servingRadiusInKms, List<ItemEntity> 
        itemEntityList) {

    List<String> itemIdList = itemEntityList.stream().map(ItemEntity::getItemId)
                              .collect(Collectors.toList());

    //To avoid the abnormal null pointer termination, use Optional                           
    ...
    //if menu is there , find the restaurant Ids
    ...
    //if restaurant id is available (for given menu), return restaurant in DAO format
  ...
  public List<Restaurant> findRestaurantsByItemName(
    ...
    //find the items are present and extract their corresponding object
    ...
    //this method in return will have restaurant list for the items we search
  ...
  public Future<List<Restaurant>> findRestaurantsByAttributesAsync(Double latitude, 
      Double longitude,String searchString, LocalTime currentTime, Double servingRadiusInKms) {
    // TODO Auto-generated method stub
    List<Restaurant> restaurantList = findRestaurantsByAttributes(latitude, longitude,
  ...
  public Future<List<Restaurant>> findRestaurantsByItemNameAsync(Double latitude, 
       Double longitude, String searchString, LocalTime currentTime, Double servingRadiusInKms) {
    // TODO Auto-generated method stub
    List<Restaurant> restaurantList = findRestaurantsByItemName(latitude, longitude,
        searchString, currentTime, servingRadiusInKms);
    return new AsyncResult<>(restaurantList);
  }
